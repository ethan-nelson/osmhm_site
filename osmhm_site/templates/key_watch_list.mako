...
<tr><th>Key</th><th>Value</th><th>Author</th><th>Note</th><th>Edit</th><th>Delete</th></tr>
% for anobject in keys:
    ...
    <td><a href="${request.route_path('key_watch_edit',id=anobject.id)}"><i class="glyphicon glyphicon-pencil" style="color: blue;"></i></a></td>
